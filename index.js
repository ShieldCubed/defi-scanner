...
// Known high-value DeFi contracts to scan
const TARGETS = [
  ...
  { name: "Yearn USDC Vault", address: "0xa354F35829Ae975e850e23e9615b11Da1B3dC4DE", tvl: 5e8, category: "Yield" },
  { name: "Uniswap V2 Router", address: "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D", tvl: 5e8, category: "DEX" },
...
async function scan() {
  ...
  for (const target of TARGETS) {
    try {
      ...
      const findings = runAllRules(bytecode);
